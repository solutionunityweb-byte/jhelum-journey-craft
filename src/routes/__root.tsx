...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JAK Tour & Travels – Premium Kashmir Tour Packages" },
      { name: "description", content: "Govt registered Kashmir travel agency in Srinagar. Premium tour packages with hotel, houseboat, Shikara ride & private cab." },
      { name: "author", content: "JAK Tour & Travels" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" },
    ],
  }),
